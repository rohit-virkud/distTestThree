(function () {
  window.rgbKineticSlider = function (options) {
    ...
    function build_scene() {
      ...
      renderer.view.style.backgroundSize = "cover";
      renderer.view.style.backgroundPosition = "center";
    ...
    function calculate(target, container) {
      ...
      imgSprite.left = containerW - targetW * r;
      imgSprite.top = containerH - targetH * r;
      imgSprite.width = container.width;
      imgSprite.height = container.height;
      imgSprite.scale = r;
    }
